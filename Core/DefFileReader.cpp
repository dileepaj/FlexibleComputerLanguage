...
void DefFileReader::AddFuncNames(MetaData* pMD, MSTRING sKey, MSTRING sVal) {
    ...
    ADD_FUNC_NAME(SET_NORMAL_STRING)
    ADD_FUNC_NAME(GET_LAST_ELEM)
    ADD_FUNC_NAME(GET_FIRST_ELEM)
    ADD_FUNC_NAME(REMOVE_FROM_START)
    ADD_FUNC_NAME(REMOVE_FROM_END)
    ADD_FUNC_NAME(REVERSE_LIST)
    ADD_FUNC_NAME(GET_NTH_ELEM)
    ADD_FUNC_NAME(CONCAT)
    ADD_FUNC_NAME(ADD_ELEM)
    ADD_FUNC_NAME(GET_PREFIX)
    ADD_FUNC_NAME(GET_SUFFIX)
    ADD_FUNC_NAME(REMOVE_ELEMENT)
    ADD_FUNC_NAME(GET_SUBLIST)
    ...
    ADD_FUNC_NAME(STRING_SPLIT)
    ADD_FUNC_NAME(ADD_NODE_NEW)
    ADD_FUNC_NAME(GET_SUB_TREE_CONTAINING_STRING)
    ADD_FUNC_NAME(IS_EMPTY)
    ADD_FUNC_NAME(CHILD)
    ADD_FUNC_NAME(ANCESTOR)
    ADD_FUNC_NAME(GET_SUB_TREE_WITH_VALUE)
    ADD_FUNC_NAME(DESCENDANT)
}
